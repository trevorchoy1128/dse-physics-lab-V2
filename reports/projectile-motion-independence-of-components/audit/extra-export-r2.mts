// 第 2 輪核數用：以作者的 model/plan 產生額外運行（角度掃描、第二顆球「同時自由下落」、參數邊界），
...
const outDir = "C:/Users/trevor/dev/dse-physics-lab/reports/projectile-motion-independence-of-components/audit/extra-data-r2";
