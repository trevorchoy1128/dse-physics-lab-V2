// 第 4 輪（模型 0.2.2；model.ts 未改、plan 只改 meta.Jmax）核數員的獨立計算：與 independent3.mjs 相同，只改輸出檔名。不讀 model.ts / plan.ts / Scene.tsx。
...
fs.writeFileSync(ROOT + "audit/independent-results-r4.json", JSON.stringify(out, null, 1));
