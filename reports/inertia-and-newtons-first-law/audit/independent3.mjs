// 第 3 輪（模型 0.2.1；plan 改歸零門檻）核數員的獨立計算：只按規格 §7 方程，逐相位閉式（等加速度）＋精確事件時間，不讀 model.ts / plan.ts。
...
fs.writeFileSync(ROOT + "audit/independent-results-r3.json", JSON.stringify(out, null, 1));
