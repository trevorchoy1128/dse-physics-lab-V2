// 核數員補跑：與 data/_export.mts 相同的 17 個運行，但 netOnly=false（原導出把 netOnly 開了，個別力箭嘴全部被隱藏）
...
const OUT = "C:/Users/trevor/dev/dse-physics-lab/.claude/worktrees/sim-024/reports/inertia-and-newtons-first-law/audit/extra-data/";
