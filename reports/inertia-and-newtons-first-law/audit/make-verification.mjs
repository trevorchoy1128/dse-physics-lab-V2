...
const audit = md("physics-audit.md"), second = md("second-impl.md"), student = md("student-test-r8.md") || md("student-test.md"), apparatus = md("apparatus-review.md");
const out = {
  simId, version, date: localDate,
  spec: "reference/13_024_慣性與牛頓運動第一定律_模擬器規格.md（v0.4：v0.3 老師 2026-09-07 核准；v0.4 摩擦改為摩擦力 f，2026-09-11，滑桿範圍與預設待老師核准）",
  tests: { total: tests.total, passed: tests.passed, items: tests.names },
  conditions: "規格 v0.4 §10 驗證條件 1–17（條件 11 改為「加速度上限 f布/m」）：1、2、5–13、15 在 model.test.ts；3、4、14、16、17 在 plan.test.ts；核數員 §1 逐條數字見 physics-audit.md",
  rounds: 8,
  reports: {
    ...
    studentTest: { file: "student-test-r8.md", rounds: ["student-test-r1.md", "student-test-r2.md", "student-test-r3.md", "student-test-r4.md", "student-test-r5.md", "student-test-r6.md", "student-test-r7.md", "student-test-r8.md"] },
    apparatusReview: { file: "apparatus-review.md", conclusion: firstLine(section(apparatus, "結論")) },
    fixLogs: ["fix-log.md", "fix-log-r2.md", "fix-log-r3.md", "fix-log-r4.md", "fix-log-r5.md", "fix-log-r7.md"],
  },
