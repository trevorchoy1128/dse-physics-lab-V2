...
{
  const ind = JSON.parse(fs.readFileSync(ROOT + "audit/independent-results-r5.json", "utf8"));
...
fs.writeFileSync(ROOT + "audit/conditions-results-r5.json", JSON.stringify(R, null, 1));
