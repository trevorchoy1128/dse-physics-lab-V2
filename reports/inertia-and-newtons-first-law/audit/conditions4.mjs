...
{
  const ind = JSON.parse(fs.readFileSync(ROOT + "audit/independent-results-r4.json", "utf8"));
...
fs.writeFileSync(ROOT + "audit/conditions-results-r4.json", JSON.stringify(R, null, 1));
