// 第 2 輪：規格 §10 驗證條件 1–17 逐條核數。條件 2/3/4/10/13/14/16 用重出的 data/（含 extra-*）；掃描類用 audit/extra-data-r2/（模型 0.2.0 重出）。
...
{
  const ind = JSON.parse(fs.readFileSync(ROOT + "audit/independent-results-r2.json", "utf8"));
...
fs.writeFileSync(ROOT + "audit/conditions-results-r2.json", JSON.stringify(R, null, 1));
