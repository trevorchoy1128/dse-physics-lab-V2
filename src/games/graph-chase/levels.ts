...
export const LEVELS: Level[] = [
  {
    ...
    brief: { zh: "車已經以 6 m s⁻¹ 行駛。目標線是一條水平線：10 秒內保持速度不變。", en: "The car is already moving at 6 m s⁻¹. The target is a horizontal line: keep the velocity steady for 10 s." },
  ...
  },
  {
    ...
    brief: { zh: "由靜止起步，4 秒內加速到 8 m s⁻¹，然後保持。", en: "Start from rest, reach 8 m s⁻¹ in 4 s, then hold it." },
  ...
  },
  {
    ...
    brief: { zh: "以 10 m s⁻¹ 行駛 3 秒，然後用 5 秒剎停，之後停住。", en: "Cruise at 10 m s⁻¹ for 3 s, then take 5 s to stop, and stay stopped." },
  ...
  },
  {
    ...
    brief: { zh: "先輕加速 4 秒，再用大一倍的加速度 4 秒，然後保持。兩段的斜率不同。", en: "Accelerate gently for 4 s, then twice as hard for 4 s, then hold. The two slopes differ." },
  ...
  },
  {
    ...
    brief: { zh: "用 6 秒慢慢加速到 3 m s⁻¹。斜率很小，油門桿要撥到最細的一格。", en: "Take 6 s to reach just 3 m s⁻¹. The slope is tiny; use the smallest notch on the lever." },
  ...
  },
  {
    ...
    brief: { zh: "以 6 m s⁻¹ 前進 2 秒，然後一直減速……減到變成倒後行駛 6 m s⁻¹。線穿過時間軸時車會發生甚麼？", en: "Move forward at 6 m s⁻¹ for 2 s, then keep decelerating… until you are reversing at 6 m s⁻¹. What happens to the car as the line crosses the axis?" },
  ...
  },
  {
    ...
    brief: { zh: "出發、掉頭、回到起點。16 秒後兩架車都應該回到 0 m：軸上面積與軸下面積互相抵消。", en: "Set off, turn round, come back. After 16 s both cars should be back at 0 m: the area above the axis cancels the area below." },
  ...
  },
  {
    ...
    brief: { zh: "16 秒，七段：起步、巡航、輕剎、再加速、最後減速。每個轉折點都要及時撥桿。", en: "16 s, seven segments: pull away, cruise, brake gently, speed up again, slow at the end. Move the lever promptly at every corner." },
