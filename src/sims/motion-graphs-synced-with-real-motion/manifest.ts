...
export const manifest: SimManifest = {
  ...
  version: "0.4.1",   // 0.4.1：meta 用歸零值、拖動改為按時間就近、還原預設不改播放狀態； 0.4.0：折線末節點 a 不再 NaN、凍結 t 截斷為 T、畫面用歸零後的 s；0.2.0：時間窗末端 a 不再歸零（第 1 輪 F1）；0.3.0：observe 把 < 1 nm 的位移殘餘歸零（第 3 輪 F6）
};
